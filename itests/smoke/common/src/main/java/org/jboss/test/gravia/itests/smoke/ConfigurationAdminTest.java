 ...
 * #L%
 */
package org.jboss.test.gravia.itests.smoke;
...
import org.jboss.test.gravia.itests.smoke.sub.d.ServiceD;
import org.jboss.test.gravia.itests.smoke.sub.d1.ServiceD1;
...
public class ConfigurationAdminTest  {
    ...
    public static Archive<?> deployment() {
        ...
        archive.addAsResource("OSGI-INF/org.jboss.test.gravia.itests.smoke.sub.d.ServiceD.xml");
        archive.addAsResource("OSGI-INF/org.jboss.test.gravia.itests.smoke.sub.d1.ServiceD1.xml");
        archive.setManifest(new Asset() {
            ...
            public InputStream openStream() {
                if (ArchiveBuilder.getTargetContainer() == RuntimeType.KARAF) {
                    ...
                    builder.addManifestHeader("Service-Component", "OSGI-INF/org.jboss.test.gravia.itests.smoke.sub.d.ServiceD.xml,OSGI-INF/org.jboss.test.gravia.itests.smoke.sub.d1.ServiceD1.xml");
