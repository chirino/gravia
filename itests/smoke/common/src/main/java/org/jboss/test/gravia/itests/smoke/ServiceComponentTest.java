...
import org.jboss.test.gravia.itests.smoke.sub.a.ServiceA;
import org.jboss.test.gravia.itests.smoke.sub.a1.ServiceA1;
...
public class ServiceComponentTest  {
    ...
    public static Archive<?> deployment() {
        ...
        archive.addAsResource("OSGI-INF/org.jboss.test.gravia.itests.smoke.sub.a.ServiceA.xml");
        archive.addAsResource("OSGI-INF/org.jboss.test.gravia.itests.smoke.sub.a1.ServiceA1.xml");
        archive.setManifest(new Asset() {
            ...
            public InputStream openStream() {
                if (ArchiveBuilder.getTargetContainer() == RuntimeType.KARAF) {
                    ...
                    builder.addManifestHeader("Service-Component", "OSGI-INF/org.jboss.test.gravia.itests.smoke.sub.a.ServiceA.xml,OSGI-INF/org.jboss.test.gravia.itests.smoke.sub.a1.ServiceA1.xml");
